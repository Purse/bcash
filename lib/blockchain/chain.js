...
class Chain extends AsyncEmitter {
  ...
  async verify(block, prev, flags) {
    ...
    // We're only connecting to one trusted node so verifying 
    // the proof-of-work is not necessary and was modified during
    // the November 15th, 2020 hardfork to use aserti3-2d
    // See: https://upgradespecs.bitcoincashnode.org/2020-11-15-asert/
    //
    // if (block.bits !== bits) {
    //   throw new VerifyError(block,
    //     'invalid',
